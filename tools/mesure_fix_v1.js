function MapPointToPointMeasure() {
    ...
    this.init = function(view, layer) {
        ...
        // coord
        this.startCoord = new itowns.Coordinates('EPSG:4326', 0, 0, 0);
        this.endCoord = new itowns.Coordinates('EPSG:4326', 0, 0, 0);
...
function convert3857To4978(coord, vec3) {
    coord.setFromVector3(vec3);
    coord.crs = 'EPSG:3857';
    coord.as('EPSG:4978', coord).toVector3(vec3);
}
...
function handleClickPoint(event) {
    ...
    if(result.length > 0){
        ...
        if(!this.startPointObj.visible){
            ...
            convert3857To4978(this.startCoord, this.startVec3);
            ...
            convert3857To4978(this.endCoord, this.endVec3);
...
function computeDistance(vec1, vec2){
    console.log('TCL: computeDistance -> vec1, vec2', vec1, vec2);
